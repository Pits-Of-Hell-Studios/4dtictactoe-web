...
/** @type {string} */
const CACHE_VERSION = '1788787972|85740444';
/** @type {string} */
const CACHE_PREFIX = '4D Tic Tac Toe-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '4D Tic Tac Toe.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["4D Tic Tac Toe.html","4D Tic Tac Toe.js","4D Tic Tac Toe.offline.html","4D Tic Tac Toe.icon.png","4D Tic Tac Toe.apple-touch-icon.png","4D Tic Tac Toe.audio.worklet.js","4D Tic Tac Toe.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["4D Tic Tac Toe.wasm","4D Tic Tac Toe.pck"];
